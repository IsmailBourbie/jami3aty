...
class Validation {
   public static function validateEmail($email, $response, $object, $found = false) {
      if (empty($email)) {
   ...
   public static function validatePassword($password, $response, $confirmPassword = null) {
   ...
   public static function validateAverage($average, $response) {
      if (empty($average)) {
   ...
   public static function validateNumCard($num_card, $response) {
      if (empty($num_card)) {
   ...
   public static function studentNotExistByAverage($average, $num_card, $object, $response) {
   ...
   public static function studentNotExistByNumCard($num_card, $object, $response) {
   ...
   public static function ifUserNotExist($num_card, $object, $response) {
